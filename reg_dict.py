# Taken from http://code.activestate.com/recipes/573466-treat-the-win32-registry-like-a-python-dict-update/
# a.k.a. http://code.activestate.com/recipes/573466/#c2
####
# Forked from the recipe at http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/551761
# A backwards compatible enhancement has been made to allow full access to registry types still through the dictionary
# metaphor
###
# Notes by Robert McGinley
###
# The original python "recipe" version 573466 has been modified, adding an expanded type allowance for arguments
# provided to the RegistryDict.__delitem__() function of str,unicode and int as opposed to just string.
# Additionally this code has been appended with several test routines which will run if the script is executed
# independently, as opposed to being imported by another script as an extension.
###
# These modifications were provided by Quintijn Hoogenboom (http://code.activestate.com/recipes/users/4171692/) in a
# comment on the version 573466 recipe listing. This comment is located here:
# http://code.activestate.com/recipes/573466/#c2
#
...
class RegistryDict(object):
    ...
    def __delitem__(self, key):
        ...
        itemtype = type(item)
        ###
        # Replacement made as per the comment: http://code.activestate.com/recipes/573466-treat-the-win32-registry-like-a-python-dict-update/#c2
        # enabling integer and unicode types to be deleted
        #        if itemtype is str:
